...
return new class extends Migration
{
    public function up()
    {
        Schema::create('courses', function (Blueprint $table) {
            ...
            // course type
            $table->unsignedBigInteger('course_type')->default(13)->nullable();
            ...
            $table->unsignedBigInteger('level_id')->default(18)->nullable();
            $table->unsignedBigInteger('status_id')->default(3)->nullable();
            $table->unsignedBigInteger('visibility_id')->default(22)->nullable();
