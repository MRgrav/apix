...
Route::patch('/my-profile/update', [AuthController::class, 'profileUpdate'])->middleware('auth:sanctum');
...
// micro apis
Route::patch('/micro/plan/expiry', [MicroController::class, 'updatePlanExpiry'])->middleware('auth:sanctum');
...
Route::get('/micro/students/{studentId}', [MicroController::class, 'getStudentById']);
